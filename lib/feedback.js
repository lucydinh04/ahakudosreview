...
// It knows only the review actions (feedback + sandbox KUDOS) and a different secret (FEEDBACK_SECRET) than production — it cannot reach Code.gs.
import { createHmac, randomBytes } from 'node:crypto';
import { HttpError } from './http.js';

export const FEEDBACK_PREFIX = 'AHAKUDOS-FEEDBACK/V1\n';
export const FEEDBACK_ACTIONS = Object.freeze({ getReviewFeedback: 0, createReviewFeedback: 1, updateReviewFeedbackStatus: 4, createReviewKudos: 3, getReviewKudos: 1 });
